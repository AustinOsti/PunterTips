let express = require('express'),
	...
	BetsList = require('./models/BetsList'),	
...
const dateFilter = "2019-06-29T21:00:00.000Z";
let betsFilter = {"$eq": new Date(dateFilter)};
let archiveFilter = {"$lt": new Date(dateFilter)};

//* send console.log to file ...
let log_file = fs.createWriteStream(extractsAnalysis + 'betanalysis_'+dateFilter.substr(0, 13)+'.txt', {flags : 'w'});
